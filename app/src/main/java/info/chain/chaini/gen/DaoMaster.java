...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        AccountTokenBeanDao.createTable(db, ifNotExists);
        AppBeanDao.createTable(db, ifNotExists);
        ChainBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        AccountTokenBeanDao.dropTable(db, ifExists);
        AppBeanDao.dropTable(db, ifExists);
        ChainBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AccountTokenBeanDao.class);
        registerDaoClass(AppBeanDao.class);
        registerDaoClass(ChainBeanDao.class);
